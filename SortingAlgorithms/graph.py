...
class SortingVisualizer:
    def __init__(self, root):
        ...
        self.algorithm_colors = {
            "Quick Sort": "#1f77b4",  # Blue
            "Merge Sort": "#ff7f0e",  # Orange
            "Heap Sort": "#2ca02c",  # Green
            "Tim Sort": "#d62728"  # Red
        }
    ...
    def setup_styles(self):
        ...
        # Create a custom style named "Big.TCheckbutton"
        self.style.layout(
            "Big.TCheckbutton",
            [
                (
        ...
        # Configure the custom style: increase indicator size, font, etc.
        self.style.configure(
            "Big.TCheckbutton",
            indicatorsize=20,  # Larger indicator (the checkbox tick)
            background="#f5f5f5",
            foreground="black",
            font=("Segoe UI", 11)
        )
